...
**Note:**
The examples in this article uses the `Notification()` constructor to create notifications. This is fine for desktop, but on most mobile browsers this will throw a `TypeError`. If you are targeting mobile devices, you should register a service worker and use `ServiceWorkerRegistration.showNotification()` instead.
...
This page was last modified on ⁨Sep 20, 2025⁩ by MDN contributors.
